Public Class FRM_Notepad
    ...
    Private Sub BTN_About_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTN_About.Click
        MsgBox("CREATED BY :- Mr. Sumit Patel", MsgBoxStyle.Information)
    End Sub
    ...
    Private Sub RTXT_NotepadText_TextChanged(sender As Object, e As EventArgs) Handles RTXT_NotepadText.TextChanged
